...
func BuiltinFixture() *Catalog {
	...
	channels := []core.Channel{
		...
		{ID: "channel_v2ex_rsshub", Source: "v2ex", RouteTemplateID: "v2ex-rsshub-latest", EndpointProfileID: "rsshub-local", Priority: 50, FallbackChannelIDs: []string{"channel_v2ex_direct"}, Enabled: true, Revision: 1},
